<form action="" method="POST" name="form-3" id="form-3">
    ...
    <table class="fp-form-table">
        ...
        <tbody class="tbl-content">
            ...
            <?php 
                ...
                $_question = new DBQuestion('form-teaching');
    ...
    <div class="btn-form-submit">
        <input type="text" name="form" value="form-3" hidden="hidden">
        <input type="submit" name="btn-form-3-submit" id="btn-form-3-submit" value="Submit" disabled>
    </div>
